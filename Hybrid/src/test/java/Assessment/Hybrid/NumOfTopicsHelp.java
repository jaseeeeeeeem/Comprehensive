...
public class NumOfTopicsHelp extends base {
	
private Logger log=LogManager.getLogger(NumOfTopicsHelp.class.getName());
	...
	@Test
	public void NumOfTopicsValidationHelp() throws InterruptedException
	{
